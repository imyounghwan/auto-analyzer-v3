/**
 * Nielsen 10 원칙 기반 43개 평가 항목의 상세 정보
 * 각 항목마다 한글명, 설명, 중요한 이유, 평가 기준을 제공
 */

const ITEM_DETAILS = {
  // N1: 시스템 상태 가시성 (Visibility of system status)
  N1_1_status_visibility: {
    ...
    evaluation_criteria: '로딩 인디케이터, 진행률 표시, 상태 메시지 등이 적절히 표시되는지 확인합니다. 5점: 모든 작업에 명확한 상태 표시, 3점: 일부 상태만 표시, 1점: 상태 표시 없음'
  },
  N1_2_feedback_timing: {
    name: '피드백 타이밍',
    description: '사용자의 액션에 대해 즉각적이고 적절한 시점에 피드백을 제공하는지 평가합니다. 버튼 클릭, 폼 제출 등의 액션 후 즉시 반응이 나타나야 합니다.',
    why_important: '지연된 피드백은 사용자로 하여금 시스템이 응답하지 않는다고 오해하게 만들어 중복 클릭이나 이탈을 유발합니다.',
    evaluation_criteria: '클릭 후 0.1초 이내 시각적 피드백 제공 여부를 확인합니다. 5점: 모든 액션에 즉각 피드백, 3점: 일부 지연, 1점: 피드백 없음'
  },
  N1_3_action_feedback: {
    name: '액션 피드백',
    description: '버튼 hover, 클릭 등 사용자 인터랙션에 대한 시각적 피드백이 제공되는지 평가합니다. 버튼 색상 변화, 애니메이션 등을 통해 사용자에게 반응을 보여줘야 합니다.',
    why_important: '시각적 피드백이 없으면 사용자는 자신의 액션이 제대로 수행되었는지 확신할 수 없어 반복 클릭이나 혼란이 발생합니다.',
    evaluation_criteria: 'hover 효과, active 상태, focus 스타일 등의 존재 여부를 확인합니다. 5점: 모든 인터랙션 요소에 피드백 제공, 3점: 일부만 제공, 1점: 피드백 없음'
  },

  // N2: 시스템과 실제 세계의 일치 (Match between system and real world)
  N2_1_familiar_terms: {
    name: '친숙한 용어 사용',
    ...
    evaluation_criteria: '메뉴명, 버튼 레이블, 안내 문구가 일반 사용자가 이해할 수 있는 언어인지 확인합니다. 5점: 모두 친숙한 용어, 3점: 일부 전문용어, 1점: 이해하기 어려운 용어'
  },
  N2_2_natural_flow: {
    name: '자연스러운 흐름',
    ...
    evaluation_criteria: '네비게이션 구조, 폼 입력 순서, 정보 계층 구조가 사용자의 멘탈 모델과 일치하는지 확인합니다. 5점: 매우 직관적, 3점: 보통, 1점: 혼란스러움'
  },

  // N3: 사용자 제어와 자유도 (User control and freedom)
  N3_1_undo_redo: {
    name: '실행 취소/재실행',
    ...
    evaluation_criteria: '폼 입력 취소, 작업 되돌리기, 삭제 후 복구 등의 기능 존재 여부를 확인합니다. 5점: 모든 주요 액션에 취소 가능, 3점: 일부만 가능, 1점: 취소 불가'
  },
  N3_2_emergency_exit: {
    name: '비상 탈출구',
    ...
    evaluation_criteria: '모달 닫기, 프로세스 취소, 이전 페이지 이동 등의 탈출 옵션이 명확히 보이는지 확인합니다. 5점: 모든 단계에 명확한 탈출구, 3점: 일부만 제공, 1점: 탈출구 없음'
  },
  N3_3_flexible_navigation: {
    ...
    evaluation_criteria: '메인 메뉴, 서브 메뉴, 검색 기능, 브레드크럼, 관련 링크 등의 네비게이션 요소를 확인합니다. 5점: 3가지 이상 제공, 3점: 2가지, 1점: 1가지만'
  },

  // N4: 일관성과 표준 (Consistency and standards)
  N4_1_visual_consistency: {
    ...
    evaluation_criteria: '버튼 스타일, 색상 팔레트, 타이포그래피, 아이콘 스타일의 일관성을 확인합니다. 5점: 완벽한 일관성, 3점: 대체로 일관적, 1점: 불일치 많음'
  },
  N4_2_terminology_consistency: {
    ...
    evaluation_criteria: '주요 액션(저장, 삭제, 수정 등)과 개념(회원, 사용자 등)의 용어 일관성을 확인합니다. 5점: 완벽한 일관성, 3점: 약간의 불일치, 1점: 심각한 불일치'
  },
  N4_3_standard_compliance: {
    ...
    evaluation_criteria: '레이아웃, 아이콘, 색상, 인터랙션이 웹 표준과 일반적 관습을 따르는지 확인합니다. 5점: 표준 준수, 3점: 일부 위반, 1점: 많은 위반'
  },

  // N5: 오류 방지 (Error prevention)
  N5_1_input_validation: {
    ...
    evaluation_criteria: '이메일, 전화번호, 날짜 등의 입력 필드에 형식 검증과 안내가 있는지 확인합니다. 5점: 모든 입력에 실시간 검증, 3점: 일부만, 1점: 검증 없음'
  },
  N5_2_confirmation_dialog: {
    ...
    evaluation_criteria: '삭제, 결제, 전송 등 주요 액션에 확인 단계가 있는지 확인합니다. 5점: 모든 중요 액션에 확인, 3점: 일부만, 1점: 확인 없음'
  },
  N5_3_constraints: {
    name: '제약 조건',
    ...
    evaluation_criteria: '날짜 선택기, 수량 입력, 옵션 선택 등에서 불가능한 값을 선택할 수 없도록 제한하는지 확인합니다. 5점: 완벽한 제약, 3점: 부분적, 1점: 제약 없음'
  },

  // N6: 회상보다는 인식 (Recognition rather than recall)
  N6_1_visible_options: {
    ...
    evaluation_criteria: '명령어 입력 대신 버튼/메뉴 제공, 이전 입력 기록 표시, 자동완성 제공 등을 확인합니다. 5점: 모든 기능이 시각적, 3점: 일부만, 1점: 기억 필요'
  },
  N6_2_recognition_cues: {
    ...
    evaluation_criteria: '아이콘의 적절성, 색상 코딩, 명확한 레이블, 툴팁 등을 확인합니다. 5점: 충분한 단서, 3점: 보통, 1점: 단서 부족'
  },
  N6_3_memory_load: {
    name: '기억 부담',
    ...
    evaluation_criteria: '다단계 폼에서 진행 상황과 입력 정보가 계속 보이는지 확인합니다. 5점: 기억 부담 없음, 3점: 약간, 1점: 많은 기억 필요'
  },

  // N7: 사용의 유연성과 효율성 (Flexibility and efficiency of use)
  N7_1_accelerators: {
    name: '단축키 지원',
    ...
    evaluation_criteria: 'accesskey 속성, skip to content 링크, 주요 기능의 단축키 존재 여부를 확인합니다. 5점: 다양한 단축키 제공, 3점: 일부만, 1점: 없음'
  },
  N7_2_personalization: {
    ...
    evaluation_criteria: '글꼴 크기 조절, 다크모드, 레이아웃 변경, 언어 선택 등의 개인화 옵션을 확인합니다. 5점: 다양한 개인화 제공, 3점: 일부만, 1점: 없음'
  },
  N7_3_batch_operations: {
    ...
    evaluation_criteria: '리스트에서 전체 선택, 다중 선택, 일괄 삭제/이동/수정 기능 존재 여부를 확인합니다. 5점: 일괄 작업 지원, 3점: 부분 지원, 1점: 지원 안 함'
  },

  // N8: 심미적이고 미니멀한 디자인 (Aesthetic and minimalist design)
  N8_1_essential_info: {
    name: '필수 정보 강조',
    ...
    evaluation_criteria: '한 화면에 표시되는 정보량, 시각적 계층 구조, 불필요한 요소 제거 정도를 확인합니다. 5점: 매우 깔끔, 3점: 보통, 1점: 복잡하고 혼잡'
  },
  N8_2_clean_interface: {
    ...
    evaluation_criteria: '여백 활용, 요소 정렬, 그룹핑, 시각적 균형을 확인합니다. 5점: 매우 깔끔, 3점: 보통, 1점: 복잡함'
  },
  N8_3_visual_hierarchy: {
    ...
    evaluation_criteria: '제목/본문 크기 차이, 색상 대비, 배치 위치의 적절성을 확인합니다. 5점: 명확한 계층, 3점: 보통, 1점: 계층 불명확'
  },

  // N9: 오류 인식, 진단, 복구 지원 (Help users recognize, diagnose, and recover from errors)
  N9_1_error_messages: {
    name: '오류 메시지 품질',
    ...
    evaluation_criteria: '오류 메시지의 명확성, 친절함, 해결 방법 제시 여부를 확인합니다. 5점: 매우 명확하고 친절, 3점: 이해 가능, 1점: 기술적/불친절'
  },
  N9_2_recovery_support: {
    name: '복구 지원',
    description: '오류 발생 시 사용자가 쉽게 복구할 수 있도록 구체적인 해결 방법과 대안을 제시하는지 평가합니다.',
    why_important: '오류를 알려주기만 하고 해결책을 제시하지 않으면 사용자는 막막해합니다.',
    evaluation_criteria: '오류 메시지에 해결 방법, 대안 링크, 고객센터 연락처 등이 포함되는지 확인합니다. 5점: 구체적 해결책 제시, 3점: 일부 안내, 1점: 안내 없음'
  },

  // N10: 도움말과 문서 (Help and documentation)
  N10_1_help_visibility: {
    name: '도움말 가시성',
    description: '사용자가 필요할 때 쉽게 도움말을 찾을 수 있는지 평가합니다. 도움말 버튼, FAQ, 가이드 링크 등이 잘 보이는 곳에 있어야 합니다.',
    why_important: '도움말이 있어도 찾기 어려우면 사용자는 포기하고 이탈합니다.',
    evaluation_criteria: '도움말 버튼의 위치, 가시성, 접근 용이성을 확인합니다. 5점: 매우 쉽게 접근, 3점: 찾을 수 있음, 1점: 찾기 어려움'
  },
  N10_2_documentation: {
    name: '문서화',
    description: 'FAQ, 매뉴얼, 튜토리얼 등 충분한 문서와 가이드가 제공되는지 평가합니다.',
    why_important: '복잡한 기능일수록 상세한 설명이 필요합니다. 좋은 문서는 지원 비용을 줄입니다.',
    evaluation_criteria: 'FAQ, 사용 가이드, 튜토리얼, 동영상 설명 등의 존재와 품질을 확인합니다. 5점: 풍부한 문서, 3점: 기본적 문서, 1점: 문서 부족'
  },

  // N11: 검색 기능 (Search functionality)
  N11_1_search_autocomplete: {
    ...
    evaluation_criteria: '검색 입력 시 자동완성 드롭다운, 인기 검색어, 최근 검색어 표시 여부를 확인합니다. 5점: 다양한 제안, 3점: 기본 자동완성, 1점: 없음'
  },
  N11_2_search_quality: {
    ...
    evaluation_criteria: '검색 결과의 정확성, 필터/정렬 옵션, 검색 결과 없을 때의 대안 제시를 확인합니다. 5점: 매우 정확, 3점: 보통, 1점: 부정확'
  },

  // N12: 반응형 디자인 (Responsive design)
  N12_1_responsive_layout: {
    ...
    evaluation_criteria: 'viewport meta 태그, 미디어 쿼리, flexible grid 사용 여부를 확인합니다. 5점: 완벽한 반응형, 3점: 부분 반응형, 1점: 고정 레이아웃'
  },
  N12_2_touch_optimization: {
    ...
    evaluation_criteria: '터치 타겟 크기, 요소 간 간격, 터치 제스처 지원 여부를 확인합니다. 5점: 최적화됨, 3점: 보통, 1점: 최적화 안 됨'
  },

  // N13: 콘텐츠 신선도 (Content freshness)
  N13_content_freshness: {
    ...
    evaluation_criteria: '최근 업데이트 날짜 표시, 게시 날짜, 뉴스/공지사항의 최신성을 확인합니다. 5점: 매우 최신, 3점: 보통, 1점: 오래됨'
  },

  // N14: 접근성 (Accessibility)
  N14_1_color_contrast: {
    ...
    evaluation_criteria: '텍스트와 배경의 명도 대비 비율을 확인합니다. 5점: WCAG AA 이상, 3점: 대체로 적절, 1점: 대비 낮음'
  },
  N14_2_keyboard_accessibility: {
    ...
    evaluation_criteria: 'Tab 순서, focus 스타일, 키보드 트랩 여부를 확인합니다. 5점: 완벽한 키보드 접근, 3점: 대부분 가능, 1점: 키보드 사용 어려움'
  },

  // N15: 파일 다운로드 (File downloads)
  N15_file_download: {
    name: '파일 다운로드',
    description: '다운로드 링크가 명확하고, 파일 형식과 크기 정보가 제공되는지 평가합니다.',
    why_important: '사용자는 다운로드 전에 파일 정보를 알아야 합니다. 예상치 못한 대용량 다운로드는 불편을 초래합니다.',
    evaluation_criteria: '다운로드 링크의 명확성, 파일 형식 표시, 파일 크기 표시 여부를 확인합니다. 5점: 모든 정보 제공, 3점: 일부 제공, 1점: 정보 없음'
  },

  // N16: 폼 복잡도 (Form complexity)
  N16_form_complexity: {
    name: '폼 복잡도',
    description: '입력 폼이 간결하고 이해하기 쉬운지, 불필요한 필드가 없는지 평가합니다.',
    why_important: '복잡한 폼은 완료율을 크게 낮춥니다. 필수 정보만 요구하는 것이 중요합니다.',
    evaluation_criteria: '입력 필드 수, 필수/선택 표시, 그룹핑, 도움말 제공 여부를 확인합니다. 5점: 간결하고 명확, 3점: 보통, 1점: 복잡하고 혼란스러움'
  },

  // N17: 성능 지표 (Performance metrics)
  N17_1_lcp_performance: {
    ...
    evaluation_criteria: 'LCP 시간을 측정합니다. 5점: 2.5초 이하, 3점: 2.5~4초, 1점: 4초 초과'
  },
  N17_2_fid_responsiveness: {
    ...
    evaluation_criteria: 'FID 시간을 측정합니다. 5점: 100ms 이하, 3점: 100~300ms, 1점: 300ms 초과'
  },
  N17_3_cls_stability: {
    name: 'CLS 안정성',
    ...
    evaluation_criteria: 'CLS 점수를 측정합니다. 5점: 0.1 이하, 3점: 0.1~0.25, 1점: 0.25 초과'
  },
  N17_4_tti_interactive: {
    ...
    evaluation_criteria: 'TTI 시간을 측정합니다. 5점: 3.8초 이하, 3점: 3.8~7.3초, 1점: 7.3초 초과'
  },

  // N18: 다국어 지원 (Multilingual support)
  N18_multilingual: {
    name: '다국어 지원',
    description: '여러 언어를 지원하거나 언어 전환 기능이 제공되는지 평가합니다.',
    why_important: '글로벌 서비스를 위해서는 다국어 지원이 필수입니다.',
    evaluation_criteria: '언어 선택 옵션, 번역 품질, lang 속성 설정을 확인합니다. 5점: 다국어 완벽 지원, 3점: 일부 지원, 1점: 단일 언어만'
  },

  // N19: 알림 기능 (Notifications)
  N19_notification: {
    name: '알림 기능',
    description: '중요한 정보를 사용자에게 적시에 알려주는 알림 기능이 있는지 평가합니다.',
    why_important: '적절한 알림은 사용자 참여도를 높이고 중요한 정보를 놓치지 않게 합니다.',
    evaluation_criteria: '푸시 알림, 이메일 알림, 인앱 알림 등의 존재와 관리 옵션을 확인합니다. 5점: 다양한 알림 제공, 3점: 기본 알림, 1점: 알림 없음'
  },
  ...
  N20_branding: {
    ...
    evaluation_criteria: '로고 배치, 브랜드 색상 사용, 일관된 메시지 톤을 확인합니다. 5점: 강한 브랜딩, 3점: 보통, 1점: 브랜딩 약함'
  }
};

/**
 * 항목 ID로 상세 정보를 가져오는 함수
 */
export function getItemDetails(itemId) {
  return ITEM_DETAILS[itemId] || {
    name: itemId,
    description: '항목 설명이 없습니다.',
    why_important: '중요도 설명이 없습니다.',
    evaluation_criteria: '평가 기준이 없습니다.'
  };
}
